Menu = Class.extend({
    ...
    draw: function(text) {
        ...
        // game title
        text = text || [{text: 'BOOM BOOM', color: '#ffffff'}, {text: ' BOMBER', color: '#ff4444'}];
        ...
        var singleIcon = new createjs.Bitmap("favicon.png");
        ...
        var multiIconGirl = new createjs.Bitmap("favicon.png");
        ...
        var multiIconBoy = new createjs.Bitmap("favicon2.png");
